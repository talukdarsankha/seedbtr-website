...
$crud=new Crud();
    ...
    if(isset($_GET['id'])){
        if(is_base64($_GET['id'])){
            ...
            if(is_numeric($id)){
                $programs_projects=$crud->Read("programsprojects","`id`='$id'");
            }else{
...
if($programs_projects){
    $image=$programs_projects[0]['image'];
    $head=$programs_projects[0]['head'];
    $description=strip_tags($programs_projects[0]['description']);
    $date=$programs_projects[0]['date_uploaded'];
}
?>
...
<body class="cr-agency">
    ...
    ?>"
        ...
        <div class="container">
            <h1 class="text-center">Programs & Projects</h1>
        </div>
    </header>
        ...
        <div class="container pb-10 mt-20">
            <div class="">
                <h6 class="mb-20 fz-20 fw-500 headTitle" id="cardHeadTitle" style="width: 100%;">
                    <?php
                        if($programs_projects && $head){
                        echo $head;
                        }else {
                        echo "programs_projects title";
                        }
                    ?>
                </h6>
            </div>
                ...
                <div class="col-5 it-col5">                   
                    ...
                    <div>
                        ...
                        ?>         
                            <div>
                                <img class=""
                                    style="width: 100%;height: 100%;padding: 6rem; border: 1px solid rgb(180, 180, 253); border-radius: 10%; box-shadow: 0px 0px 12px rgb(191, 191, 236);"
                                    src=""
                                    alt="">
                            </div>
                        <?php        
                ...
                <div class="col-7 it-col7">
                    <div>
                        <p style="text-align: justify;">
                            <?php
                                if($programs_projects && $description){
                                    echo $description;
                                }else {
