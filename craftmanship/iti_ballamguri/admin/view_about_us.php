            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <?php
                     $readAbout=$crud->Read("about_us","1 order by `id` desc");
                  ?>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <?php 
                          if ($readAbout) {
                            $n=0;
                            foreach ($readAbout as $abouts) { 
                      ?>
                      <tr>
                        <td><?php echo $abouts['id'] ;?></td>
                        <th scope="row">
                          <a href="<?= $abouts['image']; ?>"><img width="100px" src="<?php echo $abouts['image'];?>"></a>
                        </th>
                        <td>
                          <a href="#" class="text-primary fw-bold"><?php echo $abouts['head'] ;?></a>
                        </td>
                        <td><?php echo $abouts['title'] ;?></td>
                        <td class="fw-bold"><p  style="min-width: 530px;text-align: justify;"><?php echo strip_tags($abouts['description']) ;?></p></td>
                       
                        <td><span class="badge bg-success"><?php echo $abouts['date_uploaded'] ;?></span></td>
                        <td>
                          <button type="button" data-id="<?php echo $abouts['id'];?>" class="btn btn-outline-danger btn-sm editDelete"  data-bs-toggle="modal" data-bs-target="#largeModal">edit/delete</button>
                        </td>
  ...
  <div class="modal fade" id="largeModal" tabindex="-1">
              ...
              <form class="row g-3" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                      ...
                      <button id="update" data-dataId=<?= $abouts['id']; ?>  name="submit" class="btn btn-primary">update</button>
                      <a id="delete" data-dataId=<?= $abouts['id']; ?> name="delete" class="btn btn-danger">Delete</a>
                </div>
