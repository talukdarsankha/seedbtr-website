...
<section class="section dashboard">
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">View notice <span>| Details</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary fw-bold"><?php echo $notice['notice'] ;?></a></td>
                        
                        <td class="fw-bold"><?php echo strip_tags($notice['description']) ;?></td>
                       
                        <td><span class="badge bg-success"><?php echo $notice['date_uploaded'] ;?></span></td>
                        <td>
                          <button type="button" data-id="<?php echo $notice['id'];?>" class="btn btn-outline-danger btn-sm editDelete"  data-bs-toggle="modal" data-bs-target="#largeModal">edit/delete</button>
                        </td>
  ...
  <div class="modal fade" id="largeModal" tabindex="-1">
              ...
              <form class="row g-3" method="post" >
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="notice" id="notice" placeholder="news head">
                ...
                <div class="modal-footer">
                      ...
                      <button id="update" data-dataId=<?= $notice['id']; ?>  name="submit" class="btn btn-primary">update</button>
                      <a id="delete" data-dataId=<?= $notice['id']; ?> name="delete" class="btn btn-danger">Delete</a>
                </div>
