...
if(isset($_POST['ajax'])){
    ...
    if (empty($_FILES["image"]["name"])) {
        ...
        $data = [
            ...
            'TotalClassRoomsArea' =>$totalClassroomArea,
            'TotalWorkshopsArea' =>$totalWorkshopsArea,
            'DrawingHall' =>$drawingHall,
            'AudioVisualHall' =>$audioVisualHall,
            'ComputerLab' =>$computerLab,
            'Library' =>$library,
            'date_uploaded' =>$today            
        ];
        $create = $crud->Create($data,"area_infrastructure");
