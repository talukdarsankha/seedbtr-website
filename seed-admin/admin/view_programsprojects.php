...
<?php
  $ProgramsProjects=$crud->Read("programsprojects","1 order by `id` desc");
?>
				...
				<div class="page-content">
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Programs & Projects</a>
								</li>		
							</ol>
						</div>
					</div>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($ProgramsProjects) {
                                        	$n=0;
                                        	foreach ($ProgramsProjects as $ProgramProject) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
												<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 150px;" src="<?php echo $ProgramProject['image'];?>"></td>
	                                        	<td><?php echo $ProgramProject['head'] ;?></td>		                                  	
	                                        	<td style="min-width: 450px;"><?php echo $ProgramProject['description'] ;?></td>	
	                                        	<td><?php echo $ProgramProject['date_uploaded'] ;?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $ProgramProject['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $ProgramProject['id'];?>" class="tblEditBtn">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch_programsprojects.php", 
         data: {
            dataId:dataId         
         },
   ...
   $('#update').click(function(e){
	  ...
	  $.ajax({
		...
		cache: false,
		dataType: "json",
		url: "form/edit_programsprojects.php",
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_programsprojects.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
