					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">SEED</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Add news</li>
							</ol>
						</div>
					</div>
				<form id="uploadForm" action="form/addNews.php" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>important news</header>
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" name="news" type="text" id="head">
											<label  class="mdl-textfield__label">News</label>
										</div>
									</div>
