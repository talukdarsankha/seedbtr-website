				...
				<div class="page-content">
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Events Details</a>
								</li>		
							</ol>
						</div>
					</div>
											...
											if ($Events) {
												...
												<tr>
													...
													<div style="text-align: center;">
														<img style="min-width: 200px;" src="<?php echo $event['image'];?>"></td>
													<td><?php echo $event['head'] ;?></td>											
													<td style="min-width: 450px;" ><?php echo $event['description'] ;?></td>
													<td><?php echo $event['address'] ;?></td>		
													<td><?php echo $event['date_uploaded'] ;?></td>	
													<td><a href="javascript:void(0)"  data-id="<?php echo $event['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																	<i class="fa fa-pencil"></i>
														</a>
														<a href="javascript:void(0)" class="delete"  data-id="<?php echo $event['id'];?>" class="tblEditBtn">
