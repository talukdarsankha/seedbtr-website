			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add WHO'S WHO</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add WHO'S WHO</li>
							</ol>
						</div>
					</div>
				<form id="uploadForm" action="form/add_whoswho.php" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
