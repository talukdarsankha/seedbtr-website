				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">About Seed Vission</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View About Seed Vission</li>
							</ol>
						</div>
					</div>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($seedVision) {
                                        	$n=0;
                                        	foreach ($seedVision as $sv) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 150px;" src="<?php echo $sv['image1'];?>"></td>

												<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 150px;" src="<?php echo $sv['image2'];?>"></td>
	                                        	<td><?php echo $sv['head'] ;?></td>	
	                                        	<td><?php echo $sv['title'] ;?></td>	
	                                        	<td style="min-width: 350px;"><?php echo $sv['description'] ;?></td>	
	                                        	<td><?php echo $sv['date_uploaded'];?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $sv['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $sv['id'];?>" class="tblEditBtn">
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_seedvision.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
