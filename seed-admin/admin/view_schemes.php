				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Schemes</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Schemes</a>
								</li>		
							</ol>
						</div>
					</div>
                                        	...
                                        	<tr>
	                                        	...
	                                        	<td  style="min-width: 200px;">
													<div style="text-align: center;">
														<img style="min-width: 200px;" src="<?php echo $scheme['image'];?>"></td>
	                                        	<td><?php echo $scheme['head'] ;?></td>	
	                                        	<td><?php echo $scheme['title'] ;?></td>	
	                                        	<td style="min-width: 350px;" ><?php echo $scheme['description'] ;?></td>	
	                                        	<td><?php echo $scheme['date_uploaded'] ;?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $scheme['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $scheme['id'];?>" class="tblEditBtn">
