...
<?php include("include/top_section.php"); ?>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser20) {
                                        	$n=0;
                                        	foreach ($readuser20 as $announce) { ?>
                                        	<tr>
	                                        	...
	                                        	<td><?php echo $announce['date_uploaded'];?></td>	
	                                        	<!-- <td><a class="tblDelBtn" tabindex="0" aria-controls="example" type="button" a href="#" data-id="<?php echo $announce['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn"><span><i class="fa fa-pencil"></i> | <i class="fa fa-trash-o"></i></span></a>
												</td> -->
												<td><a href="<?php echo $announce['id'];?>"  data-id="<?php echo $announce['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="javascript:void(0)"  data-id="<?php echo $announce['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form action="form/edit_announcement.php" method="post" enctype="multipart/form-data">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch_announcement.php", 
         data: {
            dataId:dataId         
         },
         success: function(response){
    		...
    		$('#deletePortfolio').attr("href","form/delete_announcement.php?id="+dataId);
