...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Strategy</div>
							</div>
							...
							<div class="card-box">
								...
								<div class="card-body row">
									    ...
									    <div class="col-sm-12 col-lg-6" >
											<label  class="control-label col-md-6 col-md-12">Upload Image1
											</label>
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="strategyImage1" accept="image/*" class="dropzone" id="strategyImage1"></div>
											</div> 
											
												<img id="add_responseImage1" width="150px" height="120px" style="padding-top: 6px; border-radius: 18px; display: none;">
											
										 </div>

										 <div class="col-sm-12 col-lg-6" >
											<label  class="control-label col-md-6 col-md-12">Upload Image2
											</label>
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="strategyImage2" accept="image/*" class="dropzone" id="strategyImage2"></div>
											</div> 
											
												<img id="add_responseImage2" width="150px" height="120px" style="padding-top: 6px; border-radius: 18px; display: none;">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" name="head" type="text" id="head">
											<label  class="mdl-textfield__label">Head</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
	...
	<script>
		$('#submit').click(function(event){
			var image1=$('#strategyImage1')[0].files[0];
			var image2=$('#strategyImage2')[0].files[0];
			if(globalEditor){
			...
			if(!image1 || !image2){
				...
				Swal.fire({
				title: "please choose all images.",
				showClass: {
					popup: `
					animate__animated
					animate__fadeInUp
            ...
            if(!image1 || !image2 || !text || !head || !text){
				event.preventDefault();
...
<script src="../assets/js/twoimageboxCreate.js"></script>
</body>
