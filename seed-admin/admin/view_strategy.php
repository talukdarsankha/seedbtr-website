				...
				<div class="page-content">
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View Strategy</li>
							</ol>
						</div>
					</div>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($strategy) {
                                        	$n=0;
                                        	foreach ($strategy as $strategyKey) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 110px;" src="<?php echo $strategyKey['image1'];?>">
												</td>
														
												<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 110px;" src="<?php echo $strategyKey['image2'];?>">
												</td>

	                                        	<td><?php echo $strategyKey['head'] ;?></td>	
	                                        	<td><?php echo $strategyKey['title'] ;?></td>	
	                                        	<td style="min-width: 350px;"><?php echo $strategyKey['description'] ;?></td>	
	                                        	<td><?php echo $strategyKey['date_uploaded'];?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $strategyKey['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $strategyKey['id'];?>" class="tblEditBtn">
