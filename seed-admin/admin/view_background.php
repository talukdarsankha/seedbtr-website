...
<?php
     $backgrounds = $crud->Read("background","1 order by `id` desc");
?>
				...
				<div class="page-content">
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View background</li>
							</ol>
						</div>
					</div>
                                        	...
                                        	<tr>
	                                        	...
	                                        	<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 110px;" src="<?php echo $background['image1'];?>">
												</td>
												<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 110px;" src="<?php echo $background['image2'];?>">
												</td>

	                                        	<td><?php echo $background['head'] ;?></td>	
	                                        	<td><?php echo $background['title'] ;?></td>	
	                                        	<td style="min-width: 350px;"><?php echo $background['description'] ;?></td>	
	                                        	<td><?php echo $background['date_uploaded'];?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $background['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $background['id'];?>" class="tblEditBtn">
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_background.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
