...
<?php
  $reportsDocuments=$crud->Read("reports_documents","1 order by `id` desc");
?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Reports & Documents</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View reports and documents</a>
								</li>		
							</ol>
						</div>
					</div>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($reportsDocuments) {
                                        	$n=0;
                                        	foreach ($reportsDocuments as $rd) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td><a href="<?php echo $rd['pdf'];?>"><img width="100px" src="images/reportsDocuments/PDF_file_icon.svg.png"></a></td>	                                        
	                                        	<td style="min-width: 350px;"><?php echo $rd['news'] ;?></td>	
												<td><?php echo $rd['date_uploaded'] ;?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $rd['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $rd['id'];?>" class="tblEditBtn">
									...
									<div class="card-box">
										...
										<div class="card-body row">
											...
											<div class="col-md-6 " >
														...
														<div>
															<input type="file" style="width: 97%;" name="pdf" id="pdf" accept=".pdf*" class="dropzone">
															<img id="responseImage" width="100px" height="100px" src="images/reportsDocuments/PDF_file_icon.svg.png"
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch_reportsDocuments.php", 
         data: {
            dataId:dataId         
         },
         success: function(response){
          if(globalEditor.setData(response.news));
   ...
   $('#update').click(function(e){
	  ...
	  $.ajax({
		...
		cache: false,
		dataType: "json",
		url: "form/edit_reportsDocuments.php",
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_reportsDocuments.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
