...
<?php
   $sliders = $crud->Read("sliderphotos","1 order by `id` desc");
?>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($sliders) {
                                        	$n=0;
                                        	foreach ($sliders as $sliderphotos) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
												...
												<td><a href="javascript:void(0)"  data-id="<?php echo $sliderphotos['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
													...
													<a href="javascript:void(0)" class="deleteSlider"  data-id="<?php echo $sliderphotos['id'];?>" class="tblEditBtn">
   ...
   $('#updateSlider').click(function(e){
	  ...
	  $.ajax({
		...
		cache: false,
		dataType: "json",
		url: "form/edit_sliderPhotos.php",
   ...
   $('.deleteSlider').click(function(){
	...
	if(confirm("do you want to delete this image ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_sliderPhotos.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
