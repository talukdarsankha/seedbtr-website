...
?>
				...
				<div class="page-content">
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View CEM details</a>&nbsp;<i
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
										...
										<?php 
                                        if ($aboutBtr) {
                                            if($aboutBtr[0]['cem']=="" && $aboutBtr[0]['cem_name']=="" && $aboutBtr[0]['cem_description']=="" && $aboutBtr[0]['cem_address']=="" ){
                                               echo '
                                               <tr>
                                        ...
                                        ?>  
                                        	<tr>
	                                        	...
	                                        	<td><img width="100px" src="<?php echo $aboutBtr[0]['cem'];?>"></td>
	                                        	<td><?php echo $aboutBtr[0]['cem_name'] ;?></td>	
	                                        	<td><?php echo $aboutBtr[0]['cem_description'] ;?></td>	
	                                        	<td><?php echo $aboutBtr[0]['cem_address'] ;?></td>	
	...
	$(document).on("click touch", ".tblEditBtn", function () {    
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch-Cem.php", 
         data: {
            dataId:"1"         
         },
         success: function(response){
            $('#Name').val(response.cem_name);
			if(globalEditor){
				globalEditor.setData(response.cem_description);
			}
            if(globalEditor2){
				globalEditor2.setData(response.cem_address);
			}
            $('#responseImage').attr("src",response.cem);
