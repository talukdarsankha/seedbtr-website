...
<?php include("include/top_section.php"); ?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Who's Who</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Who's Who</a>&nbsp;<i
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser16) {
                                        	$n=0;
                                        	foreach ($readuser16 as $who) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td><img width="100px" src="<?php echo $who['image'];?>"></td>
	                                        	<td><?php echo $who['head'] ;?></td>
                                                <td><?php echo $who['title'] ;?></td>
                                                <td><?php echo $who['description'] ;?></td>
                                                <td><?php echo $who['phone'] ;?></td>
                                                	
	                                        		
	                                        	<td><?php echo $who['date_uploaded'];?></td>	
	                                        	<!-- <td><a class="tblDelBtn" tabindex="0" aria-controls="example" type="button" a href="#" data-id="<?php echo $who['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn"><span><i class="fa fa-pencil"></i> | <i class="fa fa-trash-o"></i></span></a>
												</td> -->
												<td><a href="<?php echo $who['id'];?>"  data-id="<?php echo $who['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="javascript:void(0)"  data-id="<?php echo $who['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form action="form/edit_Who.php" method="post" enctype="multipart/form-data">
										...
										<div class="card-body row">
											<div class="col-lg-6 p-t-20">
												<div
													...
													<input type="text"  id="aboutID" name="aboutID" class="mdl-textfield__input" >
                                            ...
                                            <div class="col-lg-6 p-t-20">
												<div
													...
													<input class="mdl-textfield__input" id="designation"    name="designation" type="text" >
                                            ...
                                            <div class="col-lg-6 p-t-20">
												<div
													class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<label >Address</label>
													<input class="mdl-textfield__input" id="address"  name="address" type="text" >
                                            ...
                                            <div class="col-lg-6 p-t-20">
												<div
													class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<label >Phone</label>
													<input class="mdl-textfield__input" id="phone" name="phone" type="phone" >
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch_Who.php", 
         data: {
            dataId:dataId         
         },
         success: function(response){
         	var keyed = response.name.replace(/<br ?\/?>/g,"\n");
    		$("#name").val(keyed);
            var keyed = response.designation.replace(/<br ?\/?>/g,"\n");
    		$("#designation").val(keyed);
            var keyed = response.address.replace(/<br ?\/?>/g,"\n");
    		$("#address").val(keyed);
                                              
    		var keyed = response.phone.replace(/<br ?\/?>/g,"\n");
    		$("#phone").val(keyed);
           
    		var keyed = response.date_uploaded.replace(/<br ?\/?>/g,"\n");
    		$("#date_uploaded").val(keyed);
    		$('#deletePortfolio').attr("href","form/delete_who.php?id="+dataId);
