		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser) {
                                        	...
                                        	<tr>
												...
												<td><a href="#"  data-id="<?php echo $aboutKey['id'];?>"  data-target="#model5" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="#"  data-id="<?php echo $aboutKey['id'];?>"  data-target="#model5" data-toggle="modal" class="tblEditBtn">
					...
					<div class="modal fade" id="model5" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form form action="form/edit_logo_compet.php" method="post" enctype="multipart/form-data">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$('#deletePortfolio').attr("href","form/delete-logo-compet.php?id="+dataId);
