			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">About Seed Vision</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add Seed Vision</li>
							</ol>
						</div>
					</div>
							...
							<div class="card-box">
								...
								<div class="card-body row">
									    ...
									    <div class="col-sm-12 col-lg-6" >
											...
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="Image1" accept="image/*" class="dropzone" id="Image1"></div>
											</div> 
										 ...
										 <div class="col-sm-12 col-lg-6" >
											...
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="Image2" accept="image/*" class="dropzone" id="Image2"></div>
											</div> 
