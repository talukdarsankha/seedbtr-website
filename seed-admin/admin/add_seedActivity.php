			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Bodoland SEED Activity</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add Bodoland SEED Activity</li>
							</ol>
						</div>
					</div>
							...
							<div class="card-box">
								...
								<div class="card-body row">
								  	 ...
								  	 <div class="col-sm-12 col-lg-12" >
											...
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="Image" accept="image/*" class="dropzone" id="Image"></div>
											</div> 
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" name="place" type="text" id="place">
