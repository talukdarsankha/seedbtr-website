...
<?php
  $aboutBodolandSeed=$crud->Read("about_bodolandseed","1 order by `id` desc");
?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Bodoland SEED</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View About Bodoland Seed</a>&nbsp;<i
								...
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
										...
										<tfoot>
										 ...
										 <tbody>
										<?php 
                                        if ($aboutBodolandSeed) {
                                        	$n=0;
                                        	foreach ($aboutBodolandSeed as $abs) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td  style="min-width: 150px;">
													<div style="text-align: center;">
														<img style="min-width: 150px;"  src="<?php echo $abs['image'];?>">
												</td>

	                                        	<td><?php echo $abs['head'] ;?></td>	
	                                        	<td><?php echo $abs['title'] ;?></td>	
	                                        	<td style="min-width: 250px;" ><?php echo $abs['description'] ;?></td>	
	                                        	
												<td><a href="javascript:void(0)"  data-id="<?php echo $abs['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $abs['id'];?>" class="tblEditBtn">
						        ...
						        <div class="col-sm-12">
									<div class="card-box">
										...
										<div class="card-body row">
											...
											</div><div class="col-lg-12 p-t-20">
												<div
													class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch-aboutBodolandSeed.php", 
         data: {
            dataId:dataId         
         },
   ...
   $('#update').click(function(e){
	  ...
	  $.ajax({
		...
		cache: false,
		dataType: "json",
		url: "form/edit_aboutBodolandSeed.php",
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_aboutBodolandSeed.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
