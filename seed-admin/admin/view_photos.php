				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">SEED Gallery Images</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Photos</a>
								</li>		
							</ol>
						</div>
					</div>
											...
											if ($Photos) {
												...
												<tr>
													...
													<div style="text-align: center;">
														<img style="min-width: 200px;" src="<?php echo $Photo['image'];?>"></td>
													<td style="min-width: 350px;"><?php echo $Photo['description'] ;?></td>	
													<td><?php echo $Photo['date_uploaded'] ;?></td>	
													<td><a href="javascript:void(0)"  data-id="<?php echo $Photo['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																	<i class="fa fa-pencil"></i>
														</a>
														<a href="javascript:void(0)" class="delete"  data-id="<?php echo $Photo['id'];?>" class="tblEditBtn">
                                                ...
                                                <div class="card-body row">
													...
													<div class="col-md-6 " >
														...
														<div>
															...
															<img id="responseImage" width="200px" height="250px"
