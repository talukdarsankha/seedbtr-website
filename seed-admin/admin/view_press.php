				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">News/Press</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Press Details</a>
								</li>		
							</ol>
						</div>
					</div>
											...
											if ($Press) {
												...
												<tr>
													...
													<div style="text-align: center;">
														<img style="min-width: 200px;" src="<?php echo $press['image'];?>">
													</td>
													<td><?php echo $press['head'] ;?></td>											
													<td style="min-width: 450px;"  ><?php echo strip_tags($press['description']) ;?></td>
													<td><?php echo $press['address'] ;?></td>		
													<td><?php echo $press['date_uploaded'] ;?></td>	
													<td><a href="javascript:void(0)"  data-id="<?php echo $press['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																	<i class="fa fa-pencil"></i>
														</a>
														<a href="javascript:void(0)" class="delete"  data-id="<?php echo $press['id'];?>" class="tblEditBtn">
