			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Tenders</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add Tenders</li>
							</ol>
						</div>
					</div>
				<form id="uploadForm" action="form/add_tender.php" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Tenders</header>
									
								</div>
								<div class="card-body row">
									
									<div class="col-sm-12 col-lg-12" >
											<label  class="control-label col-md-6 col-md-12">Upload Pdf
											</label>
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="pdf_file" accept=".pdf" class="dropzone" id="pdf_file"></div>
											</div> 
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" name="tenderno" type="text" id="tenderno">
											<label  class="mdl-textfield__label">tender no.</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
									...
									<div class="col-lg-12 p-t-20 text-center">
										 ...
										 <input type="submit" name="submit" value="Submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary" />
									</div>
								</div>
							</div>
						</div>
