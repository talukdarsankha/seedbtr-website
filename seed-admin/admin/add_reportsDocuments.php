					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add reports & documnets</li>
							</ol>
						</div>
					</div>
							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-sm-12 col-lg-6" >
											...
											<div class=" col-md-12">
												<div id="id_dropzone"><input type="file" style="width: 97%;" name="pdf" accept="application/pdf" class="dropzone" id="pdf"></div>
											</div> 
	...
	<script>
		$('#submit').click(function(event){
			...
			if(!pdf){
				...
				Swal.fire({
				title: "please choose any pdf file.",
				showClass: {
					popup: `
					animate__animated
					animate__fadeInUp
            ...
            if(!pdf || !text || !date){
				...
				$.ajax({
					...
					cache: false,
					dataType: "json",
					url: "form/add_reportsDocuments.php",
