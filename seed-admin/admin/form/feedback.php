...
if(isset($_POST['email'])){
    ...
    $from = $email;
    $subject = "Feedback From SeedBTR Website User";
    // $message = "<h2>Mail Received!</h2>";
    $message .=" My Name is: ". $name. "My Contact Details are as follows Email :". $email." and my feedback message is :".$message. "<br>Please Consider me as a CHC website User";
