			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add SEED MISSION</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add SEED MISSION</li>
							</ol>
						</div>
					</div>
				<form id="uploadForm" action="form/seedmission.php" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>INFORMATION SEED MISSION</header>
