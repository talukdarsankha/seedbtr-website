...
?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title"> <blockquote>SEED Activity</blockquote> </div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View seed activities</a>
								</li>		
							</ol>
						</div>
					</div>
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($seedActivity) {
                                        	$n=0;
                                        	foreach ($seedActivity as $seedactivity) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td  style="min-width: 110px;">
													<div style="text-align: center;">
														<img style="min-width: 150px;"  src="<?php echo $seedactivity['image'];?>">
												</td>

	                                        	<td><?php echo $seedactivity['head'] ;?></td>	
	                                        	<td><?php echo $seedactivity['place'] ;?></td>	
	                                        	<td style="min-width: 350px;"  ><?php echo $seedactivity['description'] ;?></td>	
	                                        	<td><?php echo $seedactivity['date_uploaded'] ;?></td>	
												<td><a href="javascript:void(0)"  data-id="<?php echo $seedactivity['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
													</a>
													<a href="javascript:void(0)" class="delete"  data-id="<?php echo $seedactivity['id'];?>" class="tblEditBtn">
									...
									<div class="card-box">
										...
										<div class="card-body row">
											...
											<div class="col-md-12 " >
														...
														<div>
															<input type="file" style="width: 97%;" name="Image" id="Image" accept="image/*" class="dropzone">
											...
											<div class="col-lg-6 p-t-20">
												<div
													class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<label>Place</label>
													<input class="mdl-textfield__input" id="place"  name="place" type="text">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch_seedActivity.php", 
         data: {
            dataId:dataId         
         },
   ...
   $('#update').click(function(e){
	  ...
	  $.ajax({
		...
		cache: false,
		dataType: "json",
		url: "form/edit_seedActivity.php",
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_seedActivity.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
