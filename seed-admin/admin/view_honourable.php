	...
	function initializeCKEditor() {
		CKEDITOR.ClassicEditor
			.create(document.querySelector("#Text"), {
				...
				placeholder: "Type a brief description for Hon'ble",
				fontFamily: {
					options: [
						'default',
...
<?php
  $Who=$crud->Read("who","1 order by `id` desc");
?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Hon'ble Details</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">View Hon'ble Details</a>
								</li>		
							</ol>
						</div>
					</div>
												...
												<tr>
													...
													<td  style="min-width: 130px;">
													  <div style="text-align: center;">
														<img style="min-width: 130px;" src="<?php echo $who['image'];?>"></td>
													<td><?php echo $who['name'] ;?></td>		
													<td><?php echo $who['designation'] ;?></td>										
													<td style="min-width: 450px;" ><?php echo $who['description'] ;?></td>
													<td><?php echo $who['date_uploaded'] ;?></td>	
													<td><a href="javascript:void(0)"  data-id="<?php echo $who['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																	<i class="fa fa-pencil"></i>
														</a>
														<a href="javascript:void(0)" class="delete"  data-id="<?php echo $who['id'];?>" class="tblEditBtn">
   ...
   $('.delete').click(function(){
	...
	if(confirm("do you want to delete this data ?")){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"form/delete_honourable.php",
			data:{dataId:id},
			success: function (response) {
			if (response.successMessage) {
				// showSuccessMessage ();
