...
.left-right-auto-scroll {
  ...
  /* background-image: url('assets/img/about/aronai-s.jpg');
  opacity: 0.4; */

  position: relative; /* Make the element a positioning context for the pseudo-element */
  background-image: url('assets/img/about/aronai-s.jpg');
...
<article class="mt-25 pb-3">
    <div class="left-right-auto-scroll">
        <div class="marquee">
            <div class="marquee__group">
              <img class="marquee_img"  src="" alt="">

                <img class="marquee_img"  src="assets/img/about/75_logo.png" alt="image">
                <img class="marquee_img"  src="assets/btr-logo.ico" alt="image">
                <img class="marquee_img"  src="assets/img/about/G20_India_LogoforUSP.png" alt="image">
                <img class="marquee_img" style="height: 60px;"  src="assets/img/logo-dark.png" alt="image" >
                <img  class="marquee_img" src="assets/img/about/btrseed.png" alt="image">
                <img  class="marquee_img" src="assets/img/about/1724937837.jpg" alt="image">
                <img  class="marquee_img" src="assets/img/about/bodoland-btr.PNG" alt="image">
                <img class="marquee_img"  src="assets/img/about/skill-india.jpg" alt="image">
                <img class="marquee_img"  src="assets/img/about/logog20.png" alt="image">
                
            </div>
        
            <div class="marquee__group">
              
                <img  class="marquee_img" src="assets/img/about/assam - Copy.jpeg" alt="image">
                <img class="marquee_img"   src="assets/img/background/1.png" alt="image" >
                <img class="marquee_img"  src="assets/img/about/make.png" alt="image's">
                <img class="marquee_img" style="height: 60px;"  src="assets/img/logo-dark.png" alt="image" >
                <img class="marquee_img"   src="assets/img/about/di.png" alt="image" >
                <img class="marquee_img"   src="assets/img/about/MYGOV200X100 (1).png" alt="image" >
              <img  class="marquee_img" src="assets/img/about/Ministry_of_Education_India.svg.png" alt="image">
              <img  class="marquee_img" src="assets/img/about/iti.png" alt="image">
        ...
        <div class="marquee marquee--reverse">
            <div class="marquee__group">
                ...
                <img class="marquee_img"  src="assets/img/about/assammap.png" alt="image">
            ...
            <div  class="marquee__group">
                ...
                <img class="marquee_img"  src="assets/img/about/about-img.jpg" alt="image">
                <img class="marquee_img"  src="seed-admin/admin/images/Gallery/1690d60835d70d42105f41e2befd3fcfg1.jpg" alt="image">
                <img class="marquee_img" style="height: 60px;"  src="assets/img/logo-dark.png" alt="image" >
                <img class="marquee_img"  src="seed-admin/admin/images/Events/87b3a472b2eacc81ea4f97ebb2ed0b0de8.jpeg" alt="image">
                <img  class="marquee_img" src="path/to/mcdonalds.png" alt="">
            </div>
        </div>
    </div>   
</article>
      ...
      <svg style="display: none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <symbol id="swachhBharat" viewBox="0 0 24 24">
            <path d="M12 2a9.998 9.998 0 0 1 10 10c0 5.523-4.477 10-10 10S2 17.523 2 12a9.998 9.998 0 0 1 10-10zm0 2a8 8 0 0 0-8 8c0 4.418 3.582 8 8 8s8-3.582 8-8a8 8 0 0 0-8-8zm3.293 4.293L12 11.586l-3.293-3.293a1 1 0 0 0-1.414 1.414L10.586 13 7.293 16.293a1 1 0 0 0 1.414 1.414L12 14.414l3.293 3.293a1 1 0 0 0 1.414-1.414L13.414 13l3.293-3.293a1 1 0 0 0-1.414-1.414z"/>
          </symbol>
